...
Cuando cambies comportamiento de contenido numerado, manten los diagnosticos CLI/build y `data/numbered-objects.json` como autoridad. Render-debug puede resumir objetos, referencias, encabezados de prueba y screenshots, pero es evidencia de inspeccion, no un data contract de reemplazo.
