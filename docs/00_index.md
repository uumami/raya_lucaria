...
Legacy implementation docs, old role guides, examples, and specs may be removed during the reset. Useful ideas from old code should be reintroduced only through current foundation decisions and new proposals.
