...
.raya-top-command-bar .raya-command-search-form + .raya-command-search {
  display: none;
}
...
.raya-calendar-page {
  --raya-calendar-kind-available: var(--raya-color-success);
  --raya-calendar-kind-cancellation: var(--raya-color-danger);
  --raya-calendar-kind-due: var(--raya-color-danger);
  --raya-calendar-kind-holiday: var(--raya-color-warning);
  --raya-calendar-kind-milestone: var(--raya-color-accent);
  --raya-calendar-kind-session: var(--raya-color-accent);
  margin: 0 auto;
  max-width: 72rem;
  min-width: 0;
  overflow-wrap: anywhere;
...
.raya-calendar-header h1,
.raya-calendar-header p,
.raya-calendar-summary,
.raya-calendar-month h2,
.raya-calendar-event h3 {
  margin-top: 0;
}
.raya-calendar-workspace,
.raya-calendar-agenda {
  display: grid;
  gap: 1rem;
  grid-template-columns: minmax(0, 1fr);
  min-width: 0;
...
.raya-calendar-event {
  background: var(--raya-color-surface);
  border: 1px solid var(--raya-color-border);
  border-inline-start: 0.25rem solid var(--raya-calendar-kind);
  border-radius: 0.5rem;
  min-width: 0;
  padding: var(--raya-space-card-padding);
}
.raya-calendar-event-header,
.raya-calendar-badges,
.raya-calendar-actions,
.raya-calendar-tags {
  align-items: center;
  display: flex;
  flex-wrap: wrap;
...
.raya-calendar-kind {
  border-color: var(--raya-calendar-kind);
  color: var(--raya-color-text);
}
.raya-calendar-type,
.raya-calendar-tags li {
...
@media (min-width: __RAYA_STRUCTURAL_PX__px) and (max-width: __RAYA_WIDE_MINUS_PX__px) {
  html[data-raya-course-map="expanded"] .raya-course-map {
    inline-size: calc(__RAYA_RAIL_EXPANDED_PX__ * 1px);
  }
}
@media (min-width: __RAYA_WIDE_PX__px) {
  html[data-raya-course-map="expanded"] .raya-course-map {
    inline-size: calc(__RAYA_RAIL_WIDE_EXPANDED_PX__ * 1px);
  }
}
...
.raya-course-map-node[data-raya-map-page-focus="true"] > .raya-course-map-node-row a {
  background: color-mix(in srgb, var(--raya-color-accent-soft) 72%, var(--raya-color-surface));
...
@media (max-width: 1500px) {
  .raya-top-command-bar .raya-command-label {
    clip: rect(0 0 0 0);
    height: 1px;
    overflow: hidden;
    position: absolute;
...
@media (min-width: __RAYA_DESKTOP_PX__px) {
  .raya-top-command-bar .raya-top-command-bar-inner {
    align-items: center;
    flex-wrap: nowrap;
    gap: 0.65rem;
    padding-block: 0.45rem;
  }
  .raya-top-command-bar .raya-reading-context {
    flex: 1 1 24rem;
    flex-wrap: nowrap;
    max-width: min(38rem, 40vw);
  }
  .raya-top-command-bar .raya-reading-context-course,
  .raya-top-command-bar .raya-reading-context-page {
    flex: 0 1 auto;
  }
  .raya-top-command-bar .raya-reading-context-section {
    max-width: min(18rem, 22vw);
  }
  .raya-top-command-bar .raya-course-tools {
    flex: 0 1 auto;
    flex-wrap: nowrap;
    max-width: calc(100% - 24rem);
  }
  .raya-top-command-bar .raya-command-group {
    align-self: center;
    flex-wrap: nowrap;
    gap: 0.25rem;
    padding: 0.15rem;
  }
  .raya-top-command-bar .raya-command-group-discovery {
    flex: 0 1 auto;
  }
  .raya-top-command-bar .raya-command-search-form {
    flex: 0 1 12rem;
    min-width: 8.5rem;
  }
  .raya-top-command-bar .raya-command-search-input,
  .raya-top-command-bar .raya-command-search-submit {
    height: 2.2rem;
    min-height: 2.2rem;
  }
  ...
  .raya-top-command-bar .raya-command-icon {
    height: 1.25rem;
    padding: 0.14rem;
    width: 1.25rem;
  }
  ...
  .raya-top-command-bar .raya-command-size .raya-command-label,
  .raya-top-command-bar .raya-command-font .raya-command-label {
    clip: auto;
    clip-path: none;
    height: auto;
    overflow: visible;
...
@media (min-width: __RAYA_APPROVED_PX__px) and (max-width: __RAYA_WIDE_MINUS_PX__px) {
...
@media (min-width: __RAYA_APPROVED_PX__px) {
  ...
  html[data-raya-course-map="collapsed"] {
    --raya-map-col: calc(__RAYA_RAIL_MINI_PX__ * 1px);
    --raya-map-gap: 1.5rem;
  }
...
@media (min-width: __RAYA_WIDE_PX__px) {
  html[data-raya-course-map="expanded"] {
    --raya-map-col: calc(__RAYA_RAIL_WIDE_EXPANDED_PX__ * 1px);
  }
}
.raya-breadcrumbs {
  color: var(--raya-color-muted);
...
/* Diagram SVGs are authored with fixed-pixel text sized for their native
   canvas (commonly ~880px); shrinking them to fit a narrow figure body
   renders that text unreadably small. Below 1470px the figure body has no
   room to shrink the diagram AND keep its dominant 11.5-12.5px labels at
   >=10px, so force native size and let the figure body's overflow-x: auto
   (see .raya-numbered-object-body) scroll horizontally instead. Measured
   with a real browser (rendered img width, not the figure body's own
   padding-inclusive clientWidth -- that overcounts by the body's
   0.85rem padding) on the reference course: shrink-to-fit alone only
   keeps the dominant 11.5px label at >=10px from a 1466px viewport
   onward; 1470px keeps a few px of margin over that measured crossover.
   Below it, shrinking pushes the same labels under 10px -- as low as
   ~4.3px at a 390px phone viewport, which is the illegible case this
   rule exists to fix. At 1470px and above, let the normal
   max-width: 100% shrink-to-fit apply (no scroll) since legibility is no
   longer at risk. Only .svg is targeted: raster illustrations must keep
   shrinking to fit at every width, and the .raya-numbered-object--figure
   scope keeps this away from SVGs used elsewhere (e.g. icons). */
...
@media (max-width: __RAYA_STRUCTURAL_MINUS_PX__px) {
  ...
  html[data-raya-course-map-drawer="open"] .raya-course-map {
    ...
    inline-size: min(calc(__RAYA_RAIL_DRAWER_PX__ * 1px), 100vw);
    block-size: 100vh;
    block-size: 100dvh;
    ...
    transition: none;
    white-space: normal;
    width: min(calc(__RAYA_RAIL_DRAWER_PX__ * 1px), 100vw);
    z-index: 80;
  }
  ...
  html[data-raya-course-map-drawer="open"] .raya-course-map-close {
    align-items: center;
    display: inline-flex;
    justify-content: center;
    min-block-size: 30px;
  ...
  html[data-raya-course-map-drawer="open"] .raya-course-map-body {
    min-block-size: 0;
    overflow: clip;
  }
  html[data-raya-course-map-drawer="open"] .raya-course-map-navigation {
    min-block-size: 0;
    overflow-x: clip;
    overflow-y: auto;
  }
...
@media (min-width: __RAYA_STRUCTURAL_PX__px) and (max-width: __RAYA_APPROVED_MINUS_PX__px) {
  ...
  html[data-raya-course-map="collapsed"] .raya-learning-shell {
    padding-left: calc(
      0.75rem + calc(__RAYA_RAIL_MINI_PX__ * 1px) + 1rem
    );
  }
  html[data-raya-learning-rail="collapsed"] .raya-learning-shell {
    padding-right: 3.75rem;
...
@media (min-width: __RAYA_STRUCTURAL_PX__px) {
  ...
  html[data-raya-course-map="collapsed"] .raya-course-map {
    ...
    padding: 0;
    pointer-events: auto;
    width: calc(__RAYA_RAIL_MINI_PX__ * 1px);
  }
  html[data-raya-course-map="collapsed"] .raya-course-map-mini {
    align-items: center;
    align-self: stretch;
    display: flex;
    flex-direction: column;
  ...
  .raya-course-map-mini > a,
  .raya-course-map-mini > button {
    align-items: center;
    background: transparent;
    border: 0;
    border-radius: 4px;
  ...
  .raya-course-map-mini > a:hover,
  .raya-course-map-mini > button:hover {
    background: color-mix(in srgb, var(--raya-color-accent-soft) 52%, var(--raya-color-surface));
  }
...
@media (max-width: 520px) {
  ...
  .raya-top-command-bar .raya-reading-context-separator {
    display: none;
  }
  .raya-top-command-bar .raya-reading-context-course,
  .raya-top-command-bar .raya-reading-context-page {
  ...
  .raya-top-command-bar .raya-reading-context-position {
    flex: 0 0 auto;
    white-space: nowrap;
  }
  .raya-reading-context-sequence {
  ...
  .raya-top-command-bar .raya-reading-context-sequence {
    flex: 0 0 auto;
    flex-wrap: nowrap;
  }
  .raya-reading-context-section-label {
  ...
  .raya-top-command-bar .raya-command-group-layout,
  .raya-top-command-bar .raya-command-group-comfort {
    flex: 1 1 auto;
    width: auto;
  }
  .raya-top-command-bar .raya-command {
  ...
  .raya-top-command-bar .raya-command-map {
    font-size: 0;
  }
  .raya-top-command-bar .raya-command-map .raya-command-icon {
    font-size: 0.75rem;
  }
  .raya-top-command-bar .raya-command-label {
    clip: rect(0 0 0 0);
