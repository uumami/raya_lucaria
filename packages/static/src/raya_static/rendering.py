...
.raya-course-map-header .raya-page-position {
  grid-column: 1;
}
...
@media (min-width: 1280px) {
  ...
  .raya-learning-shell[data-raya-course-map="expanded"][data-raya-learning-rail="collapsed"] {
    ...
    grid-template-columns: minmax(13.75rem, 13.75rem) minmax(48rem, 1fr);
  }
  ...
  .raya-learning-shell[data-raya-course-map="collapsed"] {
    ...
    grid-template-columns: minmax(48rem, 1fr) minmax(15rem, 15rem);
  }
  ...
  .raya-learning-rail[data-raya-learning-rail="collapsed"] .raya-learning-rail-expand {
    ...
    border-color: color-mix(in srgb, var(--raya-color-accent) 30%, transparent);
...
@media (max-width: 639px) {
  ...
  html[data-raya-course-map-drawer="open"] .raya-course-map-tools .raya-command-search-form {
    display: none;
  }
  html[data-raya-course-map-drawer="open"] .raya-course-map-tool-grid {
    align-items: center;
    display: flex;
    flex-wrap: nowrap;
    gap: 0.08rem;
  }
  html[data-raya-course-map-drawer="open"] .raya-course-map-tool-grid .raya-command-group {
    flex-wrap: nowrap;
  }
  html[data-raya-course-map-drawer="open"] .raya-course-map-tool-grid .raya-command-search-form + .raya-command-search {
    display: inline-flex;
  }
  html[data-raya-course-map-drawer="open"] .raya-course-map-tool-grid .raya-command-group {
    gap: 0.08rem;
...
@media (min-width: 640px) and (max-width: 1279px) {
  ...
  html:not([data-raya-shell-ready="true"]) .raya-course-map-tools,
