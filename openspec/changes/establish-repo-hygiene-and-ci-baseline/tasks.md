...
- [ ] 2.1 Implement `scripts/check-hygiene.sh` for stale guidance, generated-output pollution, OpenSpec incomplete markers, fixture labeling, and command/source-layout drift scans.
